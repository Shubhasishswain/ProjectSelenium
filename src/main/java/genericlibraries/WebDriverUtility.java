...
/**
 * This class contains all reusable webDriver method 
 * @author swain
 *
 */
...
public class WebDriverUtility {
	...
	/**
	 * This method is used to mouseHover on particular element 
	 * @param element
	 */
	...
	/**
	 * THis method is used to select from drop down based on text
	 * @param element
	 * @param text
	 */
	...
	/**
	 * THis method is used to close all tab and quite the browser
	 */
